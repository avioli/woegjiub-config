...
let s:N1   = [ '#00005f' , '#dfff00' , 7   , 5   ]
let s:N2   = [ '#ffffff' , '#444444' , 255 , 238 ]
let s:N3   = [ '#9cffd3' , '#202020' , 99  , 234 ]
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 52      , ''     ] ,
      \ }


let s:I1 = [ '#00005f' , '#00dfff' , 7   , 128 ]
let s:I2 = [ '#ffffff' , '#005fff' , 255 , 238 ]
let s:I3 = [ '#ffffff' , '#000080' , 171 , 234 ]
...
let s:V1 = [ '#000000' , '#ffaf00' , 7   , 5   ]
let s:V2 = [ '#000000' , '#ff5f00' , 255 , 238 ]
let s:V3 = [ '#ffffff' , '#5f0000' , 99  , 234 ]
